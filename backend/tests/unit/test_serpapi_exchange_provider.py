"""Unit tests for SerpApiExchangeProvider with fake HTTP client."""
...
def test_serpapi_exchange_provider_success_returns_exchange_quote():
    from app.exchange.serpapi_provider import SerpApiExchangeProvider

    provider = SerpApiExchangeProvider(
        api_key="test-key",
...
def test_serpapi_exchange_provider_sends_expected_params():
    from app.exchange.serpapi_provider import SerpApiExchangeProvider
...
def test_serpapi_exchange_provider_missing_api_key_raises():
    from app.exchange.serpapi_provider import SerpApiExchangeProvider

    with pytest.raises((ValueError, ExchangeProviderError)):
        SerpApiExchangeProvider(api_key="", http_client=FakeHTTPClient())


@pytest.mark.parametrize("status", [400, 500])
def test_serpapi_exchange_provider_http_error_raises(status: int):
    from app.exchange.serpapi_provider import SerpApiExchangeProvider
...
def test_serpapi_exchange_provider_malformed_response_raises():
    from app.exchange.serpapi_provider import SerpApiExchangeProvider
...
def test_serpapi_exchange_provider_negative_or_zero_rate_raises(rate: float):
    from app.exchange.serpapi_provider import SerpApiExchangeProvider
...
def test_serpapi_exchange_provider_client_exception_raises():
    from app.exchange.serpapi_provider import SerpApiExchangeProvider
...
def test_serpapi_exchange_provider_does_not_leak_api_key():
    from app.exchange.serpapi_provider import SerpApiExchangeProvider
...
def test_serpapi_exchange_provider_does_not_require_real_env(monkeypatch):
    from app.exchange.serpapi_provider import SerpApiExchangeProvider
...
def test_serpapi_exchange_provider_does_not_import_external_sdks():
    import app.exchange.serpapi_provider as mod
