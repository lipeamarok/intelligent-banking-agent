"""Manual controlled smoke for GrokProvider (single real call).

Security constraints:
- Reads XAI_API_KEY from environment only.
- Never prints secrets or request headers.
- Prints sanitized provider/model/content/fallback metadata only.
"""
